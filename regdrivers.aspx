<%@ Page Title="" Language="C#" MasterPageFile="~/otherpages.master" AutoEventWireup="true" CodeFile="regdrivers.aspx.cs" Inherits="register" %>
				...
				<div class="post">
					...
					<table class="tab">
                        ...
                        <tr>
                            ...
                            <td class="auto-style3">
                                <asp:TextBox ID="TextBox9" runat="server" TextMode="MultiLine" style="display:none;"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
    ...
    <div id="sidebar">
        <div class="box">
            <h2>
                Quick Links</h2>
            <ul>
                <li><a title="Aenean" href="regdrivers.aspx">Register Drivers</a></li>
                <li><a title="Suspendisse" href="viewdrivers.aspx">View Drivers</a></li>
                <li><a title="Pellentesque" href="#">Post Drivers</a></li>
                <li><a title="Mauris" href="#">Edit Drivers</a></li>
                <li><a title="semper nec faucibus" href="#">View Engaged Drivers</a></li>
